...
SELECT MEMBER, jenis_kelamin, umur, status_nikah,cooking, havebaby,games,
...
SELECT MEMBER,jenis_kelamin, umur, status_nikah, 
...
SELECT MEMBER,jenis_kelamin, umur, status_nikah ,plu,descp,merek,struk,netsales,promo,
...
WHERE COOKING = 'Y' AND havebaby = 'N' AND games = 'N'
--havebaby,games,
