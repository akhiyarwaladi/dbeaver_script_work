...
CASE 
WHEN  umur >= 0 AND umur <= 17 THEN '0-17' 
WHEN  umur >= 18 AND umur <= 26 THEN '18-26'
WHEN  umur >= 27 AND umur <= 35 THEN '27-35'
WHEN  umur >= 36 AND umur <= 45 THEN '36-45'
WHEN  umur >= 46 AND umur <= 55 THEN '46-55'
WHEN  umur >55 THEN '>55'
ELSE 'NO DATA'
END RANGE_UMUR,
count(DISTINCT member) FROM (
