--INSERT INTO ztampungan (pk, char1,char2,num1,num2,num3)
--SELECT 'cooking', char2 AS member,char3 AS plu,sum(num4) sales,sum(num5) qty,avg(num6) promo FROM ZTAMPUNGAN z WHERE pk = 'test_dn' AND char2 IN 
--(
...
)WHERE cooking = 'Y' AND havebaby = 'Y'
